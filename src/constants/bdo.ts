...
export const BDO_CLASSES: BdoClass[] = [
    ...
    { id: 'Ranger', nameEn: 'Ranger', nameRu: 'Рейнджер', role: 'ranged' },
    ...
    { id: 'Musa', nameEn: 'Musa', nameRu: 'Муса', role: 'flank' },
    ...
    { id: 'Hashashin', nameEn: 'Hashashin', nameRu: 'Хашашин', role: 'flank' },
    ...
    { id: 'Scholar', nameEn: 'Scholar', nameRu: 'Ученый', role: 'flank' },
    { id: 'Dosa', nameEn: 'Dosa', nameRu: 'Доса', role: 'flank' },
