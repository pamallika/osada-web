            ...
            <div className="relative z-10 w-full max-w-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-zinc-900/60 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 shadow-2xl shadow-black/50">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-zinc-500 mt-1.5">Система управления событиями</p>
                    </div>
                    ...
                    <form onSubmit={handleEmailLogin} className="space-y-4">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5 px-1">
                                <label className="text-[10px] font-semibold uppercase tracking-wider text-zinc-500">Пароль</label>
                                <button type="button" className="text-[10px] text-zinc-600 hover:text-violet-400 transition-colors">Забыли пароль?</button>
                            </div>
                            <input
                                type="password"
                                required
                    ...
                    <div className="flex items-center gap-3 my-6">
                        ...
                        <span className="text-[11px] text-zinc-600 whitespace-nowrap px-1">или войти через</span>
                        <div className="flex-1 h-px bg-white/[0.06]" />
                    </div>
                    ...
                    <div className="mt-8 text-center space-y-4">
                        ...
                        <p className="text-[10px] text-zinc-700 leading-relaxed max-w-[240px] mx-auto opacity-60">
